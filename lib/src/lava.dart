...
import 'package:soundsun/src/force_point.dart';
import 'package:soundsun/src/goblets.dart';
...
class Lava {
  ...
  void updateSize(Size newSize, double sizeD) {
    size = newSize;
    ...
    for (int i = 0; i < ballsCount; i++) {
      balls.add(Goblets(size, speed, sizeD));
    }
  }
