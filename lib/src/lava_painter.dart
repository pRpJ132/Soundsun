...
import 'package:soundsun/src/lava.dart';
...
class LavaPainter extends CustomPainter {
  ...
  LavaPainter({required this.lava, required this.color, required this.sizeD});

  @override
  void paint(Canvas canvas, Size size) {
    // Update the lava size if it has changed
    if (lava.size != size) lava.updateSize(size, sizeD);
